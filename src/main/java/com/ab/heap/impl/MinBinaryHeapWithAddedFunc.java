 ...
 */
public class MinBinaryHeapWithAddedFunc<T> extends BinaryHeap<T> {
    private Map<T,Integer> nodePosition = new HashMap<>();

    public static void main(String[] args) {
        BinaryHeap<Character> binaryHeap = new MinBinaryHeapWithAddedFunc<>();
        binaryHeap = getSampleCharacterBinaryHeap(binaryHeap);
        printCharacterHeap(binaryHeap);

        MinBinaryHeapWithAddedFunc<Character> minBinaryHeap = (MinBinaryHeapWithAddedFunc<Character>) binaryHeap;
